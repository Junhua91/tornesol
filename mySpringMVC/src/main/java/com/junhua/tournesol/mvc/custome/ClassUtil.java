...
public class ClassUtil {
    ...
    static public Object newInstance(String className, Map<String, String> properties) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
